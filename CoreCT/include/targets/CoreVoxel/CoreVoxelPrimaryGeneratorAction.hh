...
#ifndef CoreVoxelPrimaryGeneratorAction_h
#define CoreVoxelPrimaryGeneratorAction_h 1
...
class CoreVoxelPrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
public:
  CoreVoxelPrimaryGeneratorAction();
  virtual ~CoreVoxelPrimaryGeneratorAction();
